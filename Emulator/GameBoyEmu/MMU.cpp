...
{
	return (uint16_t) pMemory[address];
}

void MMU::Write8(uint8_t value, uint16_t address)
{
	pMemory[address] = value;
}

void MMU::Write16(uint16_t value, uint16_t address)
{
	pMemory[address] = value;
}